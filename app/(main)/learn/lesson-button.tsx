...
export const LessonButton = ({
  ...
  let indentationalLevel;
  if (cycleIndex <= 2) {
    indentationalLevel = cycleIndex;
  } else if (cycleIndex <= 4) {
    indentationalLevel = 4 - cycleIndex;
  } else if (cycleIndex <= 6) {
    indentationalLevel = 4 - cycleIndex;
  } else {
    indentationalLevel = cycleIndex - 8;
  }
  const rightPosition = indentationalLevel * 40;
